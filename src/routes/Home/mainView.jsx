    ...
    return (
        <div className="mainView mainHome">
            <div className="title container">
                <div className="myName">
                    ...
                    <div className="imagesGrid">
                        <a
                            href="https://github.com/IvanDaGomez"
                            target="_blank"
                        ...
                        <a
                            href="https://www.linkedin.com/in/ivan-gomez-79053425a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <div className="socialContainer linkedin shadow">
                                ...
                                >
                                    ...
                                    />
                                    <path
                                        d="M12.326 9.5H11.5C10.5572 9.5 10.0858 9.5 9.79289 9.79289C9.5 10.0858 9.5 10.5572 9.5 11.5V20C9.5 20.9428 9.5 21.4142 9.79289 21.7071C10.0858 22 10.5572 22 11.5 22H12C12.9428 22 13.4142 22 13.7071 21.7071C14 21.4142 14 20.9428 14 20L14.0001 16.5001C14.0001 14.8433 14.5281 13.5001 16.0879 13.5001C16.8677 13.5001 17.5 14.1717 17.5 15.2099V20C17.5 20.9428 17.5 21.4142 17.7929 21.7071C18.0858 22 18.5572 22 19.5 22H20C20.9428 22 21.4142 22 21.7071 21.7071C22 21.4142 22 20.9428 22 20V15.1641C22 11.733 21.2634 9.5 17.8787 9.5C16.1624 9.5 15.0291 10.3552 14.5223 11.1833M9.5 20V11.5C9.5 10.5572 9.5 10.0858 9.20711 9.79289C8.91421 9.5 8.44281 9.5 7.5 9.5H6.5M9.5 20V11.5C9.5 10.5572 9.5 10.0858 9.79289 9.79289C10.0858 9.5 10.5572 9.5 11.5 9.5H12.326M14.5223 11.1833L14.0001 11.0935C13.0001 10.9065 12.4428 11.4428 12.1443 12.5"
                                        stroke="currentColor"
                                        strokeWidth="1.5"
                                    />
                                </svg>
                        ...
                        >
                            <div className="socialContainer instagram shadow">
                                ...
                                >
                                    ...
                                    />
                                    <path
                                        d="M17 11.5C17 14.2614 14.7614 16.5 12 16.5C9.23858 16.5 7 14.2614 7 11.5C7 8.73858 9.23858 6.5 12 6.5C14.7614 6.5 17 8.73858 17 11.5Z"
                                        stroke="currentColor"
                                        strokeWidth="1.5"
                                    />
                                    <path
            ...
            <div ref={circleParent} className="exp container ">
                <div className="instExp">
                    <div className="outerCircle">
                        <div className="circle shadow">1-2</div>
                    </div>
                    Years Experience
                </div>
                <div className="instExp">
            ...
            <div className="about container">
                ...
                <div ref={aboutRef}>
                    <li>
                        <span>Name:</span> Ivan David Gomez Silva
                    </li>
                    <li>
                        <span>Birth Date:</span> July 12 of 2006
                    </li>
                    <li>
                        <span>City:</span> Bucaramanga, Santander, Colombia
                    </li>
                    <li>
                        <span>Email:</span> ivandavidgomezsilva@hotmail.com
                    </li>
                    <li>
                        <span>Phone:</span> +57 302 469 0359
                    </li>
                </div>
            </div>
        </div>
